...
const CHAPTER_1_DIALOGUES: Array = [
	...
	},
	{
		"id": "ch1_006",
		"chapter": 1,
		"bg": "01_02_station_platform_sunset",
		"speaker": "",
		"type": "narrator",
	...
	},
	{
		...
		"right": "strangerNearTheHostel/strangerNearTheHostel_Neutral"
	},
	{
		"id": "ch1_016",
		"chapter": 1,
	...
	},
	{
		...
		"left": "daria_main/daria_neutral",
		"right": "strangerNearTheHostel/strangerNearTheHostel_smile"
	},
	{
		"id": "ch1_023",
		"chapter": 1,
	...
	},
	{
		"id": "ch1_144",
		"chapter": 1,
		"bg": "01_10_university_courtyard_day",
		"speaker": "",
		"type": "narrator",
	...
	},
	{
		...
		"speaker": "",
		"type": "narrator",
		"text": "Годинник показував пів на дев'яту. Всі мовчки приготувались до священного моменту: ось-ось і сюди зайде архіваріус мудрості, магістр заліків, покровитель конспектів!"
	},
	{
		"id": "ch1_165",
		"chapter": 1,
		...
		"speaker": "",
		"type": "narrator",
		"text": "Ну, або як в народі кажуть, просто викладач."
	},
	{
		"id": "ch1_166",
		"chapter": 1,
	...
	},
	{
		...
		"speaker": "",
		"type": "narrator",
		"text": "Наступною парою була лекція з предмету «Вступ до мовознавства». Меланія запитала чи можна сісти поряд з Дарією знову."
	},
	{
		"id": "ch1_209",
		"chapter": 1,
		...
		"speaker": "",
		"type": "narrator",
		"text": "Дівчина погодилась і обидві зрозуміли, що вклали угоду на цілий семестр. Лекція теж пройшла добре, але викликала легке приголомшення. Студенти виходили повільно, хоч і були раді, що навчання на сьогодні завершилось. Дарія виходила однією з останніх. В голові досі крутились якісь нові терміни: «фонема», «морфема». Це все здавалось таким важким.. Вона не знала, що буде робити, але була впевнена, що буде робити щось велике."
	},
	{
		"id": "ch1_210",
		"chapter": 1,
