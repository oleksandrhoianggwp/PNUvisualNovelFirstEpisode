...
const CHAPTER_2_DIALOGUES: Array = [
	...
	},
	{
		...
		"speaker": "",
		"type": "narrator",
		"text": "Подумала Дарія і миттю вилізла з-під теплої ковдри. Ранок наступного дня почався не так як хотілось. Ймовірно через те, що вчора вдалось отримати море емоцій, її сон був міцним. Вона не почула мелодії першого будильника, тож зараз стурбовано поспішала на пари. На ходу, одночасно допиваючи чашку ароматної кави, Дарія попрощалась з сусідками в думках гадаючи чи зможуть вони колись змусити її прокинутися, якщо вона не почує жоден з дзвінків."
	},
	{
		"id": "ch2_003",
		"chapter": 2,
	...
	},
	{
		...
		"speaker": "",
		"type": "narrator",
		"text": "Дарія відверто боялась наступних слів викладачки, невідомо як вона ставиться до запізнень. Та Меланія уже переступила поріг аудиторії,"
	},
	{
		"id": "ch2_027",
		"chapter": 2,
		...
		"speaker": "",
		"type": "narrator",
		"text": "тому довелось тільки покладатись таки на те, що першого разу вони можуть обійтись меншим «виговором»."
	},
	{
		"id": "ch2_028",
		"chapter": 2,
	...
	},
	{
		...
		"speaker": "",
		"type": "narrator",
		"text": "Як уже було відомо, староста підійшов першим, але представлятись не поспішав."
	},
	{
		"id": "ch2_095",
		"chapter": 2,
	...
	},
	{
		...
		"speaker": "Дарія",
		"type": "thought",
		"text": "Але я не могла заперечувати: було щось у цьому хлопцеві, що чіпляло. Хотілося дізнатися про нього більше.",
		"center": "daria_main/daria_neutral"
	},
	{
		"id": "ch2_098",
	...
	},
	{
		...
		"speaker": "",
		"type": "narrator",
		"text": "піти, адже студентство – найкращий час для розвитку себе як особистості у різних сферах діяльності. Тож всі рушили за вказаним словами"
	},
	{
		"id": "ch2_174_2",
		"chapter": 2,
	...
	},
	{
		...
		"speaker": "Дарія",
		"type": "dialogue",
		"text": "Попереджай наступного разу або хоча б відповідай на дзвінок.",
		"center": "daria_main/daria_smile"
	},
	{
		"id": "ch2_249",
